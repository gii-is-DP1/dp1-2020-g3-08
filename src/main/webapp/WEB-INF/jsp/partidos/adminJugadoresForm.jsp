    ...
    <form:form modelAttribute="partido" class="form-horizontal"
        ...
        <div class="form-group has-feedback">
        	...
        	<div class="control-group">	
	            	<petclinic:selectField label="Arbitro" name="arbitro"
						size="5" names="${arbitros}" />
	        </div>
        	<div class="control-group">	
	            	<petclinic:selectField label="Equipo1" name="equipo1"
						size="5" names="${equipos}" />
	        </div>
	        <div class="control-group">	
	            	<petclinic:selectField label="Equipo2" name="equipo2"
						size="5" names="${equipos}" />
	        </div>
            <div class="control-group">	
