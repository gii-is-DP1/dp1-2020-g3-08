...
//		Assertions.assertThat(jugador1.getNombre()).startsWith("Daniel");
//		Assertions.assertThat(jugador1.getEquipo().getNombre()).isEqualTo("Betis");
//
//	}
//
//	@Test
...
//		Assertions.assertThat(equipo1.getJugadores().size()).isEqualTo(found + 1);
//
//		try {
...
//		Assertions.assertThat(jugador.getId()).isNotNull();
//	}
//
//	@Test
//	@Transactional
...
//		Assertions.assertThat(jugador1.getNombre()).isEqualTo(newName);
//	}
//
//	@Test
//	@Transactional
